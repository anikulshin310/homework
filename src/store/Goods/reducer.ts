...
// Все-таки стор это стор, и в случае с редаксом не видел кейсов, когда у тебя стор ==== данным с сервера (чем он у тебя сейчас фактически является). Лучше, если все-таки это будет объект, у которого одно из полей - dataItems. Так легче будет стор расширять в дальнейшем
